...
Every clue renderer receives the same typed fact, character names, room label, and optional scene
icon token. A translation may reorder those parts to sound natural, but it must preserve the exact
logical relation, the friendly motivation, and the icon token. Tests render every clue family in
...
The following example uses one fact: Aina is in the reading room, immediately above the lamp, and
brings a book. These sentences document the intended short, reusable composition style rather than
storing puzzle copy:

| Locale | Composition example                                                                                     |
| ------ | ------------------------------------------------------------------------------------------------------- |
| `ca`   | Aina prepara amb il·lusió la sala de lectura, a la casella damunt del llum, i hi porta un llibre.       |
| `es`   | Aina prepara con ilusión la sala de lectura, en la casilla sobre la lámpara, y lleva un libro.          |
| `en`   | Aina happily prepares the reading room, in the cell above the lamp, and brings a book.                  |
| `eu`   | Ainak gogotsu prestatzen du irakurketa-gela, lanpararen gaineko laukian, eta liburu bat darama.         |
| `gl`   | Aina prepara con ilusión a sala de lectura, na cela sobre a lámpada, e leva un libro.                   |
| `fr`   | Aina prépare avec plaisir la salle de lecture, dans la case au-dessus de la lampe, et apporte un livre. |
| `de`   | Aina bereitet mit Freude den Leseraum vor, im Feld über der Lampe, und bringt ein Buch mit.             |
